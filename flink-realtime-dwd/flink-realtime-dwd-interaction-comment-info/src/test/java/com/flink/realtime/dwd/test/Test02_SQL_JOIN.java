...
/**
 * @Package com.flink.realtime.dwd.test.Test02_SQL_JOIN
 * @Author guo.jia.hui
 * @Date 2025/4/11 18:50
 * @description: 该案例演示通过flinksql实现双流join
 */
public class Test02_SQL_JOIN {
    public static void main(String[] args) {
        ...
        //TODO 5.内连接
        //注意：如果使用的普通的内外连接，底层会为参与连接的两张表各自维护一个状态，用于存放两张表的数据：默认情况下，状态不会失效
        //生产环境中，一定要设置状态的保留时间
...
//        tableEnv.executeSql("select e.empno,e.ename,d.deptno,d.dname from emp e left join dept d on e.deptno = d.deptno").print();
        //TODO 7.右外连接
//        tableEnv.executeSql("select e.empno,e.ename,d.deptno,d.dname from emp e right dept d on e.deptno = d.deptno").print();
        //TODO 8.全外连接
