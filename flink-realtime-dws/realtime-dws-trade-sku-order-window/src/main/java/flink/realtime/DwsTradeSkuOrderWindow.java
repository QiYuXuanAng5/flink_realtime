package flink.realtime;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.struggle.flink.realtime.common.base.BaseApp;
import com.struggle.flink.realtime.common.bean.TradeSkuOrderBean;
...
import static com.struggle.flink.realtime.common.util.decodeBase64.decodeBase64ToBigDecimal;

/**
 * @Package flink.realtime.DwsTradeSkuOrderWindow
 * @Author guo.jia.hui
 * @Date 2025/4/20 22:17
 * @description: 下单聚合
 */
    ...
    public void handle(StreamExecutionEnvironment env, DataStreamSource<String> kafkaStrDS) {
        ...
        SingleOutputStreamOperator<TradeSkuOrderBean> beanDS = withWatermarkDS.map(
                (MapFunction<JSONObject, TradeSkuOrderBean>) jsonObj -> {
                    ...
                    // Base64 解码并转换为 BigDecimal
                    BigDecimal splitCouponAmount = decodeBase64ToBigDecimal(jsonObj.getString("split_coupon_amount"));
                    BigDecimal splitActivityAmount = decodeBase64ToBigDecimal(jsonObj.getString("split_activity_amount"));
                    BigDecimal splitTotalAmount = decodeBase64ToBigDecimal(jsonObj.getString("split_total_amount"));
